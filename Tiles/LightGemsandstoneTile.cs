...
namespace EEMod.Tiles
{
    public class LightGemsandstoneTile : EETile
    {
        public override void SetStaticDefaults()
        {
            ...
            ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<LightGemsandstone>();
            //SoundStyle = 1;
            MineResist = 1f;
            MinPick = 0;
        }
